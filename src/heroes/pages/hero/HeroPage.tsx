...
export const HeroPage = () => {
  ...
  const { data: superheroData, isError } = useHero(slug);
  if (isError) {
    return <Navigate to="/" />;
  }
  ...
  const totalPower =
    (superheroData.strength ?? 0) +
    (superheroData.intelligence ?? 0) +
    (superheroData.speed ?? 0) +
    (superheroData.durability ?? 0);
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                ...
                >
                  {superheroData.category ?? "Sin categoría"}
                </Badge>
                <Badge
                ...
                >
                  {superheroData.status ?? "Desconocido"}
                </Badge>
                <Badge
                  variant="secondary"
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-2">
                {superheroData.alias ?? "Sin alias"}
              </h1>
              <p className="text-xl text-blue-200 mb-4">
                {superheroData.name ?? "Desconocido"}
              </p>
              <p className="text-lg text-gray-300 max-w-2xl">
                {superheroData.description ?? "Sin descripción"}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={(superheroData.strength ?? 0) * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={(superheroData.intelligence ?? 0) * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={(superheroData.speed ?? 0) * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress
                    value={(superheroData.durability ?? 0) * 10}
                    className="h-2"
                  />
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="w-12 text-right font-bold">
                      {superheroData.intelligence ?? 0}/10
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">
                      {superheroData.alias ?? "Desconocido"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b">
                    ...
                    <span className="font-semibold">
                      {superheroData.firstAppearance ?? "Desconocido"}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-2">
